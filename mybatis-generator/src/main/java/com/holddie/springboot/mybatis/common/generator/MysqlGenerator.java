    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUrl("jdbc:mysql://10.20.69.237:3306/maven-demo?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                }.setFileOutConfigList(Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/vmtp/mapper.xml.vm") {
                    // 自定义输出文件目录
                    @Override
